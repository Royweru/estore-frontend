...
export const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-neutral-50 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      ...
      <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0 font-semibold">
